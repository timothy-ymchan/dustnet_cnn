...
class DustNet(nn.Module):
    def __init__(self, in_chan, out_chan, bypass=None, **kwargs):
        ...
        self.conv_l0 = ResBlockDropout(in_chan, 64, seq='COACOBA')
        self.down_l0 = ConvBlockDropout(64, seq='DOBA')
        self.conv_l1 = ResBlockDropout(64, 64, seq='COBACOBA')
        self.down_l1 = ConvBlockDropout(64, seq='DOBA')

        self.conv_c = ResBlockDropout(64, 64, seq='COBACOBA')

        self.up_r1 = ConvBlockDropout(64, seq='UOBA')
        self.conv_r1 = ResBlockDropout(128, 64, seq='COBACOBA')
        self.up_r0 = ConvBlockDropout(64, seq='UOBA')
        self.conv_r0 = ResBlockDropout(128, out_chan, seq='COAC')
